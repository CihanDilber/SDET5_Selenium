...
public class _01_WaitsGiris extends BaseDriver {
    ...
    public void Wait1()
    {
        ...
        Duration muhlet= Duration.ofSeconds(120);    // elemani bulmasi icin 120 sn muhlet verdik burada ancak bulunca kapaniyor.
        driver.manage().timeouts().implicitlyWait(muhlet);

        //MyFunc.Bekle(30);  // bu programi durduruyor.  // sayfayla da bir ilgisi olmadigi icin sonuna kadar bekler
        // Interview lerde bekletme olarak kullandigimizi soylemiyoruz
